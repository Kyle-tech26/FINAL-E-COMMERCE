        ...
        <div class="product-div">
            <div class="product-div-left">
                ...
                <div class="hover-container">
                    <div><img src="img/prod1.png" onclick="changeImage('img/prod1.png')"></div>
                    <div><img src="img/prod2.png" onclick="changeImage('img/prod2.png')"></div>
                    <div><img src="img/prod3.png" onclick="changeImage('img/prod3.png')"></div>
                    <div><img src="img/prod4.png" onclick="changeImage('img/prod4.png')"></div>
                    <div><img src="img/prod5.png" onclick="changeImage('img/prod5.png')"></div>
                </div>
            </div>
            <div class="product-div-right">
                <span class="product-name">Bench Tumbler</span>
                <span class="product-price">₱ 459.00 <del style="color: red;">₱ 918.00</del> </span>
                ...
                <div class="btn-groups">
                    <!-- Add to Cart Button -->
                    <button type="button" class="add-cart-btn" onclick="addToCart('Bench Tumbler', 459.00, document.getElementById('main-image').src)">
