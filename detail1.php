        ...
        <div class="product-div">
            <div class="product-div-left">
                ...
                <div class="hover-container">
                    <div><img src="img/prod6.png" onclick="changeImage('img/prod6.png')"></div>
                    <div><img src="img/prod7.png" onclick="changeImage('img/prod7.png')"></div>
                    <div><img src="img/prod8.png" onclick="changeImage('img/prod8.png')"></div>
                    <div><img src="img/prod9.png" onclick="changeImage('img/prod9.png')"></div>
                    <div><img src="img/prod10.png" onclick="changeImage('img/prod10.png')"></div>
                </div>
            </div>
            <div class="product-div-right">
                <span class="product-name">Travel Tumbler</span>
                <span class="product-price">₱ 365.00 <del style="color: red;">₱730.00</del> </span>
                ...
                <div class="btn-groups">
                    <!-- Add to Cart Button -->
                    <button type="button" class="add-cart-btn" onclick="addToCart('Travel Tumbler', 365.00, document.getElementById('main-image').src)">
